...
/**
 * The length of encryption keys is 128 bits, represented as MK = ( MK0, MK1, MK2, MK3 ), in which MKi (i = 0, 1, 2, 3) is a word.<br>
 * A round key is represented as (rk0, rk1, … , rk31), where each rki (i = 0, …, 31) is a word. It is generated by the encryption key.<br>
 * FK  = (FK0, FK1, FK2, FK3) is a system parameter.<br>
 * CK = (CK0, CK1, … , CK31) is a fixed parameter, used to generate rki.<br>
 * FKi and CKi are words, used for extension of the algorithm.<br>
 * @author k.dynowski
 *
 */
public class SM4 {
